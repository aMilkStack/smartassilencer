      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              setIsShaking(false);
              playSuccessSound(); // Follow up with satisfying chime
            }, 600);
          }, 200);
...
<div
      ref={pullRefreshRef}
      className="h-screen overflow-auto relative flex flex-col items-center justify-center p-2 md:p-4"
      style={{
...
<HandwritingTextarea
            ...
            {step === 'loading' && (
                <div className={`min-h-[24rem] flex flex-col items-center justify-center gap-6 ${
                    pageTransition === 'flip-out' ? 'animate-page-flip-out' : 'animate-fade-slide-in'
                }`}>
...
<button onClick={() => { playClickSound(); reset(); }} className="text-gray-400 hover:text-black font-bold underline decoration-wavy flex items-center gap-1 group btn-press active:scale-95 transition-transform animate-bounce-in" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
